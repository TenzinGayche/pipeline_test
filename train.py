...
def main():
    ...
    train_dataloader = DataLoader(
        train_dataset, shuffle=True, collate_fn=lambda data: dict(data_collator(data)), batch_size=args.per_device_train_batch_size
    )
    eval_dataloader = DataLoader(eval_dataset, collate_fn=lambda data: dict(data_collator(data)), batch_size=args.per_device_eval_batch_size)
